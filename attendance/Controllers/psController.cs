...
namespace attendance.Controllers
{
    public class psController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "PersinalScheduleID,pin,schedule_id,ScheduleStart,SheduleEnd")] personal_schedule personal_schedule)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "PersinalScheduleID,pin,schedule_id,ScheduleStart,SheduleEnd")] personal_schedule personal_schedule)
        {
            if (ModelState.IsValid)
            {
